    ...
    <ul role="list" className="divide-y divide-gray-100">
      {expenses.map(
        (expense: Expense): React.ReactElement => (
          <li
            key={`${expense.date}#${expense.expenseId}`}
          ...
          >
            ...
            <div className="flex shrink-0 items-center gap-x-6">
              <div className="hidden sm:flex sm:flex-col sm:items-end">
                ...
                <p className="text-sm/6 text-gray-900">{expense.category}</p>
              </div>
              <Menu as="div" className="relative flex-none">
                ...
                >
                  <MenuItem>
                    ...
                    >
                      View profile<span className="sr-only">, {expense.category}</span>
                    </a>
                  </MenuItem>
                  <MenuItem>
                    <a
                      ...
                      className="block px-3 py-1 text-sm/6 text-gray-900 data-focus:bg-gray-50 data-focus:outline-hidden"
                    >
                      Message<span className="sr-only">, {expense.expenseId}</span>
                    </a>
                  </MenuItem>
                </MenuItems>
              </Menu>
