        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="text-center">
            <h1 className="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">
              Meet Walter. Your money’s new best friend.
            </h1>
            <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">
              Walter uses AI to track your spending, monitor your portfolio, and deliver smart,
              personalized financial insights straight to your inbox—so you can master your money
