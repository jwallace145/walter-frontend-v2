...
const Register: React.FC = (): React.ReactElement => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>): void => {
    ...
    if (!isValidEmail(email)) {
      ...
      setMessage('Please ensure your email address is valid and try again.');
      setShowError(true);
      return;
    }
    ...
    <>
      <div className="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <Link href="/">
            <Logo className="mx-auto h-10 w-auto" width={40} height={40} />
          </Link>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full flex justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-base font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
